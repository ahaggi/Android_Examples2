...
package com.example.haji.examples2.boundservice;
...
import com.example.haji.examples2.boundservice.BoundService.MyBinder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stopServiceButon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ServicesMain.this,
                        BoundService.class);
                stopService(intent);
            }
        });
